            ...
            RunAlgosBtn {
                ...
                onClicked:{
                    if (sourceInput.text ===""){
                        ...
                        backend.checkDirectedNodeExist(sourceInput.text)}
                }
            }              
    ...
    Connections{
        ...
        function onSetExist(bol){
            if(bol === "True"){
                ...
                backend.minPrim('directed',sourceInput.text)
...
/*##^##
Designer {
    D{i:0;formeditorZoom:0.5}D{i:9;invisible:true}D{i:14}D{i:15}D{i:16}D{i:17;invisible:true}
}
##^##*/
