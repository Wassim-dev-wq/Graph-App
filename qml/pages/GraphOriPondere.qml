    ...
    Connections{
        ...
        function onGetVal(val){
            if(val === "True"){
                ...
                anim1.running = true;
                anim2.running = true;
                backend.addWeightedDiEdge(customEdgeTextDe.text,customEdgeTextA.text,weightEdge.text);
...
D{i:40;invisible:true}D{i:41;invisible:true}D{i:43;invisible:true}D{i:42;invisible:true}
}
##^##*/
