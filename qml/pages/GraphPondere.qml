    ...
    Rectangle {
        ...
        Rectangle {
            ...
            TextField {
                ...
                x: 230
                y: 98
                placeholderText: qsTr("Poid")
                validator: IntValidator {bottom: 1; top: 150000}
                background: Rectangle {
                    radius: 5
                    implicitWidth: 70
                    implicitHeight: 40
            ...
            SequentialAnimation {
                id: animWarning
                NumberAnimation {
                    targets: [customEdgeTextDe,customEdgeTextA,weightEdge]
                    properties: "y"
                    to: 110
                    duration: 60
                }
            ...
            CustomAddBtn {
                ...
                clip: true
                    ...
                    onClicked: {
                        if (customEdgeTextDe.text===""||customEdgeTextA.text===""||weightEdge.text===""){
    ...
    Connections{
        ...
        function onGetVal(val){
            if(val === "True"){
                ...
                anim1.running = true;
                anim2.running = true;
                backend.addWeightedEdge(customEdgeTextDe.text,customEdgeTextA.text,weightEdge.text);
...
/*##^##
Designer {
    D{i:0;autoSize:true;formeditorZoom:0.5;height:480;width:640}D{i:40;invisible:true}
D{i:41;invisible:true}
}
##^##*/
